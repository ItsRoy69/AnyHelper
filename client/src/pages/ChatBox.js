...
const ChatBox = () => {
  ...
  const ENDPOINT = `https://anyhelper-server.onrender.com`;

  const getUserSpaces = async () => {
    const res = await Axios.post(`https://anyhelper-server.onrender.com/chat/get-users-spaces`, {
  ...
  const sendMessage = async (e, space) => {
    ...
    console.log(data);
    if (message) {
      await Axios.post("https://anyhelper-server.onrender.com/chat/send-message", data, {
