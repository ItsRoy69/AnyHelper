...
const WorkersList = ({ customer }) => {
  ...
  const handleCustomerConnect = async(worker) => {
    await axios.post(
      `https://anyhelper-production.up.railway.app/chat/create-space`, {
        ...
        console.log("Space Created");
        axios.post('https://anyhelper-production.up.railway.app/customers/create-order',{
          name : user.name,
          email : user.email,
  ...
  const type = localStorage.getItem("type");
    ...
    await Axios.get(`https://anyhelper-production.up.railway.app/workers/get-all-workers`).then((res) => {
