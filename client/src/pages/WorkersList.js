...
const WorkersList = ({ customer }) => {
  ...
  const handleConnect = async(worker) => {
    await axios.post(
      `https://anyhelper-server.onrender.com/chat/create-space`, {
        admin : user.email,
  ...
  const handleCustomerConnect = async(worker) => {
    await axios.post(
      `https://anyhelper-server.onrender.com/chat/create-space`, {
        ...
        console.log("Space Created");
        axios.post('https://anyhelper-server.onrender.com/customers/create-order',{
          name : user.name,
          email : user.email,
  ...
  const type = localStorage.getItem("type");
    ...
    await Axios.get(`https://anyhelper-server.onrender.com/workers/get-all-workers`).then((res) => {
